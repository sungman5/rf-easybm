...
export default function MobileNav({isNavOpen, openNav}){
    ...
    return(
        <nav aria-hidden={!isNavOpen} id="mobile-menu" className="fixed inset-0 z-[509999] flex flex-col px-4 py-4 overflow-y-auto translate-x-full bg-BM-white">
            ...
            <div className="py-4 border-b border-b-BM-line lg:text-center lg:text-lg">
                ...
                <ul>
                    ...
                    <li className="lg:py-2"><Link onClick={openNav} className={pathname === '/basic/4' ? "block px-2 rounded py-1 font-medium bg-BM-background text-BM-font" : "block px-2 rounded py-1 font-medium text-BM-font"} href={'basic/4'}>첫 화면 이해하기</Link></li>
                </ul>
            </div>
            <div className="py-4 border-b border-b-BM-line lg:text-center lg:text-lg">
            ...
            <div className="py-4 mb-8 border-b border-b-BM-line lg:text-center lg:text-lg">
                ...
                <ul>
                    ...
                    <li className="lg:py-2"><Link onClick={openNav} className={pathname === '/advanced/3' ? 'block px-2 rounded py-1 font-medium bg-BM-background text-BM-font' : "px-2 rounded block py-1 font-medium text-BM-font"} href={'advanced/3'}>1인분만 주문하고 싶어!</Link></li>
                    ...
                    <li className="lg:py-2"><Link onClick={openNav} className={pathname === '/advanced/5' ? 'block px-2 rounded py-1 font-medium bg-BM-background text-BM-font' : "px-2 rounded block py-1 font-medium text-BM-font"} href={'advanced/5'}>싫어하는 음식은 빼달라고 하고 싶어!</Link></li>
                    <li className="lg:py-2"><Link onClick={openNav} className={pathname === '/advanced/6' ? 'block px-2 rounded py-1 font-medium bg-BM-background text-BM-font' : "px-2 rounded block py-1 font-medium text-BM-font"} href={'advanced/6'}>생활에 필요한 물건도 배달 받고 싶어!</Link></li>
