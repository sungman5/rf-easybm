    ...
    <>
      <div className='flex flex-col flex-grow h-full'>
        ...
        <section className='flex flex-col w-full'>
          <Image id='bm-character' tabIndex={0} className='mx-auto' width={796} height={353} alt='시각장애인, 발달장애인, 노인 캐릭터' src={'/img/cover.png'} />
          <nav>
            <ul className='lg:flex'>
              <li className='flex flex-1 bg-BM-primary lg:h-60'>
                <Link aria-label='준비하기' href={'/basic/0'} className='w-full px-4 py-4 text-BM-black'>
                  <Image src={'/img/basic_imgs/basic-title.png'} width={204} height={64} className='w-32 mb-2 md:w-40 lg:w-48' alt='준비하기' />
