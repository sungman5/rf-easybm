            ...
            <ul>
                <li className="py-4 border-b">
                    ...
                    <div className="flex font-medium text-BM-primary">
                        ...
                        <p className="text-base text-BMgray500">“피자가 2만 원, 배달팁이 2천 원이니까 모두 2만 2천 원이네.”</p>
                    </div>

                </li>
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl md:text-2xl font-hanna text-BM-primary">최소주문금액</h3>
                    <p className="md:leading-relaxed md:text-lg md:mb-2">배달시킬 때 꼭 채워야 하는 주문 금액. 가게마다 최소주문금액이 다르다. 최소주문금액만큼은 주문해야 배달시킬 수 있다.</p>
                    <div className="flex font-medium text-BM-primary">
                        <svg aria-hidden={true} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMtertiary">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 6.828a.75.75 0 10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z" clipRule="evenodd" />
                        </svg>
                        <p className="text-base text-BMgray500">“최소주문금액이 8천 원이니까 8천 원 이상은 주문해야겠다.”</p>
                    </div>
                </li>
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl md:text-2xl font-hanna text-BM-primary">찜</h3>
                    <p className="md:leading-relaxed md:text-lg md:mb-2">마음에 드는 가게를 골라 놓는 것. 찜 하면 마음에 드는 가게를 빨리 찾을 수 있어서 편하다.</p>
                    <div className="flex font-medium text-BM-primary">
                        <svg aria-hidden={true} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMtertiary">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 6.828a.75.75 0 10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z" clipRule="evenodd" />
                        </svg>
                        <p className="text-base text-BMgray500">“이 집 맛있네. 다음에 배달시키게 찜 해야겠다.”</p>
                    </div>
                </li>
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna md:text-2xl text-BM-primary">리뷰</h3>
                    <p className="md:leading-relaxed md:text-lg md:mb-2">가게에서 음식을 시켜 본 다음 나의 느낌이나 생각을 적는 것. 음식이 맛있었는지, 직원이 친절했는지 자유롭게 적을 수 있다. 사진을 함께 올릴 수 있다.</p>
                    <div className="flex font-medium text-BM-primary">
                        <svg aria-hidden={true} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMtertiary">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 6.828a.75.75 0 10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z" clipRule="evenodd" />
                        </svg>
                        <p className="text-base text-BMgray500">“리뷰가 좋은데? 여기서 시켜 먹어야겠다.”</p>
                    </div>
                </li>
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BM-primary md:text-2xl">별점</h3>
                    <p className="md:leading-relaxed md:text-lg md:mb-2">가게의 음식을 먹어 보고 만족한 만큼 점수를 주는 것. 1점부터 5점까지 줄 수 있다. 별점이 높은 가게는 고객이 만족한 가게라는 뜻이다.</p>
                    <div className="flex font-medium text-BM-primary">
                        <svg aria-hidden={true} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMtertiary">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 6.828a.75.75 0 10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z" clipRule="evenodd" />
                        </svg>
                        <p className="text-base text-BMgray500">“별점이 4.8점이면 엄청 높네! 여기 맛집인가 봐.”</p>
                    </div>
                </li>
                {/* <li className="py-4 border-b">
                ...
                <li className="py-4 border-b">
                    ...
                    <p className="md:leading-relaxed md:text-lg md:mb-2">일반 배달보다 빠르게 배달하는 서비스. ‘배민원’이라고 읽는다. 한집배달, 알뜰배달 2가지 종류가 있다.</p>
                    <div className="flex font-medium text-BM-primary">
                        <svg aria-hidden={true} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMtertiary">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 6.828a.75.75 0 10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z" clipRule="evenodd" />
                        </svg>
                        <p className="text-base text-BMgray500">“배민1으로 주문했더니 배달이 엄청 빨리 왔네.”</p>
                    </div>
                </li>
                <li className="py-4 border-b">
                    <h3 className="mb-2 text-xl font-hanna text-BM-primary md:text-2xl">한집배달</h3>
                    <p className="md:leading-relaxed md:text-lg md:mb-2">한 번에 한 집만 배달하는 서비스. 여러 집에 가지 않고 우리 집으로 바로 음식을 배달해 준다.</p>
                    <div className="flex font-medium text-BM-primary">
                        <svg aria-hidden={true} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMtertiary">
                            <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm2.023 6.828a.75.75 0 10-1.06-1.06 3.75 3.75 0 01-5.304 0 .75.75 0 00-1.06 1.06 5.25 5.25 0 007.424 0z" clipRule="evenodd" />
                        </svg>
                        <p className="text-base text-BMgray500">“배고프니까 한집배달로 빨리 받아 봐야지!”</p>
                    </div>
                </li>
                <li className="py-4 border-b">
                    ...
                    <div className="flex font-medium text-BM-primary">
                        ...
                        <p className="text-base text-BMgray500">“알뜰배달로 주문해서 배달팁을 조금 아껴 볼까?”</p>
                    </div>
                </li>
                <li className="py-4 border-b">
                    ...
                    <div className="flex font-medium text-BM-primary">
                        ...
                        <p className="text-base text-BMgray500">“순살치킨을 양념 소스에 찍어 먹으면 더 맛있어!”</p>
                    </div>
                </li>
                <li className="py-4 border-b">
                    ...
                    <div className="flex font-medium text-BM-primary">
                        ...
                        <p className="text-base text-BMgray500">“옵션으로 치즈 토핑을 추가해서 치즈 닭갈비를 먹어야지.”</p>
                    </div>
                </li>
                <li className="py-4 border-b">
                    ...
                    <div className="flex font-medium text-BM-primary">
                        ...
                        <p className="text-base text-BMgray500">“피자를 시킬 때 사이드 메뉴로 스파게티를 시키면 좋아.”</p>
                    </div>
                </li>
                {/* <li className="py-4 border-b">
