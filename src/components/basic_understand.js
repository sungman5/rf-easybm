    ...
    return (
        <section className="h-full leading-relaxed">
            ...
            <ul>
                ...
                <li className="py-3 border-b md:text-lg">
                    <p className="mb-1 text-lg md:py-2 md:text-2xl font-hanna text-BMprimary">2. 전체 서비스</p>
                    <p>배달의민족 앱에서 이용할 수 있는 모든 서비스를 볼 수 있다.</p>
                </li>
                <li className="py-3 border-b md:text-lg">
                    <p className="mb-1 text-lg md:py-2 md:text-2xl font-hanna text-BMprimary">3. 알림센터</p>
                    <p>여러 가지 알림을 확인할 수 있다. 빨간 점이 있다면 새로운 알림이 도착했다는 뜻이다.</p>
                </li>
                <li className="py-3 border-b md:text-lg">
                    <p className="mb-1 text-lg md:py-2 md:text-2xl font-hanna text-BMprimary">4. My배민(마이 배민)</p>
                    <p>내가 찜한 가게, 내 주문 내역 등 나와 관련된 정보를 볼 수 있다.</p>
                </li>
                <li className="py-3 border-b md:text-lg">
                    <p className="mb-1 text-lg md:py-2 md:text-2xl font-hanna text-BMprimary">5. 검색</p>
                    <p>원하는 메뉴나 가게를 검색해 바로 찾을 수 있다.</p>
                </li>
                <li className="py-3 border-b md:text-lg">
                    <p className="mb-1 text-lg md:py-2 md:text-2xl font-hanna text-BMprimary">6. 빠른 배달</p>
                    <p>오른쪽의 배달보다 빠르게 받을 수 있다.</p>
                    <p className="text-sm font-medium text-BM-gray200">
                        지역에 따라 배민1과 배달의 버튼 위치가 다르다. 배민1이 안 보이는 곳도 있다.
                    </p>
                </li>
                <li className="py-3 border-b md:text-lg">
                ...
                <li className="py-3 border-b md:text-lg">
                    <p className="mb-1 text-lg md:py-2 md:text-2xl font-hanna text-BMprimary">8. 포장</p>
                    <p>주문한 음식을 직접 가지러 가는 것이다. 배달팁이 들지 않는다.</p>
                </li>
