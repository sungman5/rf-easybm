export const basic = [
...

    {
        ...
        tutoContents: [
            ...
            {
                id: '2',
                desc: '<p>위치기반 서비스 동의에 체크한다. 마케팅 정보 알림에 동의하면 체크하고 시작하기를 누른다.</p>',
            ...
            {
                id: '3',
                desc: '<p>배달받을 주소를검색한다.</p><p className="caption">&#96;서울시 중구 소소로 123, 101호&#96;면, 소소로 123만 입력한다.</p>',
                img: '/img/basic_imgs/b-4-3.jpg',
                alt: '배달받을 주소를 입력하는 화면이다. 검색창에 문래북로116을 입력해서 검색하고 있다.',
            },
            {
                id: '4',
                desc: '<p>상세 주소를 입력하고 완료를 누른다.</p><p className="caption">상세주소: 건물 이름이나 동, 호 등 주소의 뒷부분</p>',
    ...
    },
    {
        ...
        tutoContents: [
            ...
            {
                id: '5',
                desc: '<p>이름, 생년월일, 휴대전화 번호를 쓰고 &#91;인증번호 요청&#93;을 누른다.</p> <p className="caption">인증번호: 실제로 사용하는 전화인지 확인하는 숫자. 문자로 받는다.</p>',
                img: '/img/basic_imgs/b-5-5.jpg',
                alt: '회원가입을 위한 본인인증 화면이다. 화면 맨 아래에 휴대폰 인증하기 버튼이 있고 손가락 모양의 아이콘이 버튼을 가리키고 있다.',
            },
            {
                id: '6',
                desc: '<p>문자로 온 인증번호 4자리를 입력하고&#91;확인&#93;을 누른다.</p>',
            ...
            {
                id: '7',
                desc: `<p>이메일 주소를 입력하고 &#91;중복확인&#93;을 누른다.</p> 
            ...
            {
                id: '8',
                desc: '<p>닉네임, 비밀번호, 생년월일을 입력하고 완료를 누른다.</p> <p className="text-sm font-medium">비밀번호는 10자보다 길게 만든다. 영어, 숫자, 특수문자 중 2가지 종류를 섞는다.</p>',
...
export const usage = [
    ...
    },
    {
        ...
        content: [
            ...
            {
                id: '3',
                desc: '<p>무엇을 시킬지 선택하고, 몇 개 시킬지 수량을 정한 후 담기를 누른다.</p> <span class="caption">맛, 소스, 토핑 등을 선택할 수 있다.</span>',
                img: '/img/usage/rg-2-3.jpg',
                alt: 'BLT 샌드위치를 선택하고, 추가 옵션으로 코우슬로 샐러드, 콘 스프를 추가한 화면이 나타나 있다. 21,000원 담기 버튼이 강조되어 있고, 손가락 모양이 가리키고 있다.',
            },
            {
                id: '4',
                desc: '<p>&#91;장바구니에 메뉴를 추가했습니다&#93;라는 메시지가 뜨고, 장바구니에 숫자가 생긴다.</p> <span className="caption">선택한 음식 개수만큼 장바구니에 숫자로 표시된다.</span>',
    ...
    },
    {
        ...
        content: [
            ...
            {
                id: '2',
                desc: '주문하려는 메뉴, 개수, 가격이 맞는지 확인하고 &#91;배달 주문하기&#93;를 누른다.',
            ...
            {
                id: '4',
                desc: '화면 맨 아래로 내려간다. 결제 수단에서 신용/체크카드를 선택하고 결제하기를 누른다.',
            ...
            {
                id: '5',
                desc: '결제수단이 신용/체크카드인지 확인하고 본인 확인 후 결제하기를 누른다. <span className="caption">첫 주문이 아니라면 바로 결제할 수 있다.</span>',
            ...
            {
                id: '10',
                desc: `<svg aria-label="체크버튼" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline w-6 h-6 text-BMprimary">
            ...
            {
                id: '12',
                desc: '주문금액과 배달팁이 맞는지 확인하고 &#91;결제하기&#93;를 누른다. <span className="caption">주문 후 취소하려면 어렵고 복잡하다. 주문은 신중하게!</span>',
            ...
            {
                id: '13',
                desc: '이용약관에 &#91;전체동의&#93;를 체크한 후, 결제에 사용할 카드를 선택한다.',
...
export const advanced = [
    ...
    },
    {
        ...
        tutorial_title: '가게 사장님께 이렇게 사용해보세요!',
        content: [
            {
                id: 1,
    ...
    },
    {
        ...
        desc:
        {
            ...
            icon_alt: 'B마트 아이콘',
            body: [
                { id: 1, item: 'B마트<span aria-hidden="true">(비마트)</span>는 생활에 필요한 물건 배달입니다.' },
        ...
        content: [
            {
                ...
                desc: `배달의민족 첫 화면에서 B마트<span aria-hidden="true">(비마트)</span>를 누른다.`,
