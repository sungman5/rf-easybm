export const basic = [
...

    {
        ...
        tutoContents: [
            ...
            {
                id: '3',
                desc: '배달받을 주소를 검색한다.<strong>`서울시 중구 소소로 123, 101호`</strong>면, <strong>`소소로 123`</strong>만 입력한다.',
                img: '/img/basic_imgs/b-4-3.png',
                alt: '배달받을 주소를 입력하는 화면이다. 검색창에 문래북로116을 입력해서 검색하고 있다.',
            },
            {
                id: '4',
                desc: '상세 주소를 입력하고 <strong>완료</strong>를 누른다.',
                img: '/img/basic_imgs/b-4-4.png',
                alt: '상세 주소를 입력하는 화면이다. 트리플렉스 1504호라고 입력하고 있다.',
            },
            {
                id: '5',
                desc: '배달받을 주소가 설정되었다. 음식을 주문하면 내가 정한 주소로 배달받을 수 있다.',
    ...
    },
    {
        ...
        tutoContents: [
            ...
            {
                id: '3',
                desc: '<strong>이메일 또는 아이디로 계속하기</strong>를 누른다.',
            ...
            {
                id: '5',
                desc: `<p className="mb-2">동의하는 내용에 체크하고 <strong>시작하기</strong>를 누른다.*필수에 꼭 체크해야 앱을 이용할 수 있다. 선택은 원하면 체크한다.</p>`,
            ...
            {
                id: '8',
                desc: '문자로 온 인증번호 6자리를 입력하고 <strong>확인</strong>을 누른다.',
            ...
            {
                id: '9',
                desc: `이메일 주소를 입력하고 <strong>중복확인</strong>을 누른다. 
                회원가입을 하려면 이메일 주소가 있어야 한다.`,
                img: '/img/basic_imgs/b-5-9.png',
                alt: '메시지함에 도착한 인증번호 6자리가 입력되어 있고, 손가락 모양의 아이콘이 확인 버튼을 가리키고 있다.',
            },
            {
                id: '10',
                desc: '닉네임, 비밀번호, 생년월일을 입력하고 <strong>완료</strong>를 누른다. 비밀번호는 10자보다 길게 만든다. 영어, 숫자, 특수문자 중 2가지 종류를 섞는다.',
                img: '/img/basic_imgs/b-5-10.png',
...
export const usage = [
    ...
    },
    {
        ...
        content: [
            ...
            {
                id: '2',
                desc: '주문하려는 메뉴, 수량, 가격이 맞는지 확인하고 배달 방식을 선택한다. 그 다음 <strong>배달 주문하기</strong>를 누른다.',
    ...
    },
    {
        ...
        desc:
        {
            ...
            body: [
                ...
                { id: 2, item: '내 위치 근처 포장할 수 있는 가게를 찾을 수 있습니다.' },
