...
export const usage = [
    ...
    },
    {
        ...
        content: [
            ...
            {
                id: '3',
                desc: '<p>무엇을 시킬지 선택하고, 몇 개 시킬지 수량을 정한 후 담기를 누른다. </p> <span class="caption lg:text-left">맛, 소스, 토핑 등 옵션을 선택할 수 있다.</span>',
                img: '/img/usage/rg-2-3.png',
                alt: 'BLT 샌드위치를 선택하고, 추가 옵션으로 코우슬로 샐러드, 콘 스프를 추가한 화면이 나타나 있다. 21,000원 담기 버튼이 강조되어 있고, 손가락 모양이 가리키고 있다.',
            },
            {
                id: '4',
                desc: '<p>&#91;장바구니에 메뉴를 추가했습니다&#93;라는 메시지가 나오고, 장바구니에 숫자가 생긴다.</p> <span className="caption lg:text-left">선택한 수량만큼 장바구니 보기에 숫자로 표시된다.</span>',
    ...
    },
    {
        ...
        content: [
            ...
            {
                id: '2',
                desc: '주문하려는 메뉴, 수량, 가격이 맞는지 확인하고 &#91;배달 주문하기&#93;를 누른다.',
            ...
            {
                id: '12',
                desc: '주문 금액과 배달팁이 맞는지 확인하고 &#91;결제하기&#93;를 누른다. <p className="caption lg:text-base lg:text-left">주문 후 취소하려면 어렵고 복잡하다. 주문은 신중하게!</p>',
            ...
            {
                id: '13',
                desc: '이용약관 동의에 &#91;전체동의&#93;를 체크한 후, 결제에 사용할 카드를 선택한다.',
