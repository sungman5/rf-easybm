export const basic = [
...

    {
        ...
        tutoContents: [
            ...
            {
                id: '3',
                desc: '<p>배달받을 주소를검색한다.</p><p className="caption lg:text-left lg:text-base lg:text-BM-gray200">서울시 중구 소소로 123, 101호면, 소소로 123만 입력한다.</p>',
                img: '/img/basic_imgs/b-4-3.png',
                alt: '배달받을 주소를 입력하는 화면이다. 검색창에 문래북로116을 입력해서 검색하고 있다.',
            },
            {
                id: '4',
                desc: '<p>상세 주소를 입력하고 완료를 누른다.</p><p className="caption lg:text-left lg:text-base lg:text-BM-gray200">상세주소: 건물 이름이나 동, 호 등 주소의 뒷부분</p>',
...
export const usage = [
    ...
    },
    {
        ...
        content: [
            ...
            {
                id: '5',
                desc: '결제수단이 신용/체크카드인지 확인하고 본인 확인 후 결제하기를 누른다. <p className="lg:text-left lg:text-base caption">첫 주문이 아니라면 바로 결제할 수 있다.</p>',
            ...
            {
                id: '12',
                desc: '주문금액과 배달팁이 맞는지 확인하고 &#91;결제하기&#93;를 누른다. <p className="caption lg:text-base lg:text-left">주문 후 취소하려면 어렵고 복잡하다. 주문은 신중하게!</p>',
