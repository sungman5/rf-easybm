export const basic = [
...

    {
        ...
        tutoContents: [
            ...
            {
                id: '2',
                desc: '<p>동의하는 내용에 체크하고 시작하기를 누른다. `필수`에 꼭 체크해야 앱을 이용할 수 있다. &#91;선택&#93;은 원하면 체크한다.</p>',
            ...
            {
                id: '3',
                desc: '<p>배달받을 주소를 검색한다.</p><p className="caption lg:text-left lg:text-base lg:text-BM-gray200">&#91;서울시 중구 소소로 123, 101호&#93;면, &#91;소소로 123&#93;만 입력한다.</p>',
    ...
    },
    {
        ...
        tutoContents: [
            ...
            {
                id: '4',
                desc:`<p>동의하는 내용에 체크하고&#91;시작하기&#93;를 누른다.</p><p className="text-BM-gray200, text-base"> '필수'에 꼭 체크해야 앱을 이용할 수 있다. '선택'은 원하면 체크한다.</p>`,
            ...
            {
                id: '6',
                desc: '<p>이름, 생년월일, 휴대전화 번호를 쓰고 &#91;인증번호 요청&#93;을 누른다.</p> <p className="caption lg:text-left">인증번호: 실제로 사용하는 전화인지 확인하는 숫자. 문자로 받는다.</p>',
                img: '/img/basic_imgs/b-5-6.png',
                alt: '회원가입을 위한 본인인증 화면이다. 화면 맨 아래에 휴대폰 인증하기 버튼이 있고 손가락 모양의 아이콘이 버튼을 가리키고 있다.',
            },
            {
                id: '7',
                desc: '<p>문자로 온 인증번호 6자리를 입력하고&#91;확인&#93;을 누른다.</p>',
